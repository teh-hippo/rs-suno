...
use suno_core::{
    AdoptDecision, AreaKind, AreaListing, ArtifactToggles, ClerkAuth, Clip, Config, FlagOverrides,
    LIKED_PLAYLIST_ID, LineageContext, NamingConfig, Owner, OwnerGate, PlaylistDesired,
    PlaylistInput, PlaylistState, ResolveOpts, SourceMode, SunoClient, adopt_decision,
    adoption_enumerated, album_desired, area_mode, build_desired, build_modes_by_id,
    build_playlist_desired, build_scoped_playlist_desired, clip_stems, deletion_allowed,
    is_downloadable, library_authoritative, narrows_downloads, owner_gate, resolve_roots,
...
use crate::cli::desired::{
    ...
    mass_delete_abort, resolve_playlist, resolve_selection, worse,
};
